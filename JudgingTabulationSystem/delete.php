...
<?php
	...
	if(isset($_SESSION['username'])) {
		if ($_SESSION['username'] !== 'AdminDave') {
			if (isset($_POST["deletecontestant"]) || isset($_POST["deletecategory"]) || isset($_POST["deletecriteria"]) || isset($_POST["deletecriconcat"])) {
				echo '<script>alert("Only the admin can modify the data. You are not allowed to change data.");</script>';
			}
		} else {
	...
	/*
	if(isset($_SESSION['username']) && $_SESSION['username'] === 'AdminDave') {
		if (isset($_POST["deletecontestant"])) {
				$contestant = $_POST['contestantid_del'];
	...
	*/
	...
	elseif(isset($_SESSION['username']) && $_SESSION['username'] === 'AdminDave'){
	...
	elseif(isset($_SESSION['username']) && $_SESSION['username'] === 'AdminDave'){
		if (isset($_POST["deletecriconcat"])) {
		$criconcat = $_POST['criconcat_del'];
