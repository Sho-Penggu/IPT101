...
<head>
  ...
  <link rel="shortcut icon" href="img/hcdc_logo.png"/>
	<title>Tabulation for Hcdc Ambassadress 2023</title>
...
<body class="flare-bg">
  ...
  <form action="index.php" method="post" id="frmCompute"> 
    <div class="row animated fadeInLeft">
      ...
      <a href="view.php"><input type="button" class="editrecord" title="Edit Record"></a><a href="index-admin.php"><input type="button" class="Admin" title="Admin for Modifying"></a> <a href="report.php"><input type="button" class="report" title="Report"></a> <a href="index.php?logout=1"><input type="button" class="logout" title="Logout"></a></span></h3>
